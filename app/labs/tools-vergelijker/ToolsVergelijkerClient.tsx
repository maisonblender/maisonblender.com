...
export default function ToolsVergelijkerClient() {
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex flex-col gap-1.5">
                <label htmlFor="tools-filter-categorie" className="text-xs font-medium uppercase tracking-widest text-[#6b6b75]">
                  Categorie
                </label>
                <select
                  id="tools-filter-categorie"
                  value={categorie}
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="tools-filter-prijs" className="text-xs font-medium uppercase tracking-widest text-[#6b6b75]">
                  Prijs
                </label>
                <select
                  id="tools-filter-prijs"
                  value={prijsFilter}
              ...
              <div className="flex flex-col gap-1.5">
                <span id="tools-filter-gdpr-legend" className="text-xs font-medium uppercase tracking-widest text-[#6b6b75]">
                  GDPR
                </span>
                <div className="flex items-center gap-2 rounded-lg border border-black/10 bg-white px-3 py-2 text-sm text-[#1f1f1f] transition-colors hover:border-[#22c55e]/40">
                  <input
                    id="tools-filter-gdpr"
                    type="checkbox"
                    checked={gdprFilter}
                    onChange={(e) => setGdprFilter(e.target.checked)}
                    className="accent-[#22c55e]"
                    aria-describedby="tools-filter-gdpr-legend"
                  />
                  <label htmlFor="tools-filter-gdpr" className="cursor-pointer">
                    Alleen compliant
                  </label>
                </div>
              </div>
            ...
            {/* Weergave toggle */}
            <div className="flex gap-2" role="group" aria-label="Weergave">
              <button
                type="button"
                aria-pressed={weergave === "kaarten"}
                onClick={() => setWeergave("kaarten")}
                className={`flex items-center gap-1.5 rounded-lg px-3 py-2 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#22c55e] focus-visible:ring-offset-2 ${
                  weergave === "kaarten"
      ...
      {weergave === "tabel" && (
        <section className="px-6 py-16 bg-[#f2f3f5]">
          <div className="mx-auto max-w-6xl overflow-x-auto">
            <table className="w-full border border-black/[0.06] bg-white">
              <caption className="sr-only">
                Vergelijkingstabel van AI-tools met categorie, prijs, Nederlandse taalondersteuning, GDPR-status en sterktes.
              </caption>
              <thead className="border-b border-black/[0.06] bg-[#f2f3f5]">
                <tr>
                  <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-widest text-[#575760]">
                    Tool
                  </th>
                  <th scope="col" className="px-4 py-3 text-left text-xs font-medium uppercase tracking-widest text-[#575760]">
                    Categorie
