...
Read [reference.md](reference.md) for all 29 patterns with before/after examples.
...
2. Read [reference.md](reference.md) and identify all pattern instances
...
For all 29 patterns with before/after examples, see [reference.md](reference.md).
