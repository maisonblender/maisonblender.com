...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDescription: [
      "De volgende stap na chatbots zijn AI-agents: autonome digitale medewerkers die zelfstandig taken uitvoeren, beslissingen nemen en systemen aansturen. MAISON BLNDR ontwikkelt custom AI-agents die werken als verlengstuk van je team - dag en nacht, zonder fouten door vermoeidheid of afleiding.",
      ...
      "MAISON BLNDR bouwt deze agents op maat, gebaseerd op jouw specifieke processen en systemen. Wij werken met de nieuwste frameworks zoals LangChain en multi-agent orkestratie om agents te laten samenwerken op complexe workflows. Je krijgt een schaalbare, veilige oplossing die meegroeit met je organisatie.",
    ],
    benefits: [
  ...
  },
  {
    ...
    longDescription: [
      "Standaardsoftware is gebouwd voor iedereen - en dus voor niemand perfect. Als je processen complex genoeg zijn om een eigen aanpak te verdienen, bouwt MAISON BLNDR de software die precies past bij hoe jij werkt. Niet aanpassen aan het systeem, maar het systeem aanpassen aan jou.",
  ...
  },
  {
    ...
    longDescription: [
      "Veel bedrijven weten dat AI kansen biedt, maar weten niet waar te beginnen of wat het hen concreet oplevert. Precies daar begint de samenwerking met MAISON BLNDR: met een gratis automatiseringsquickscan die in beeld brengt welke van je processen het meest geschikt zijn voor AI-automatisering en wat de verwachte impact is.",
