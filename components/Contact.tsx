      ...
      <div className="mx-auto max-w-3xl text-center">
        <div className="flex flex-col items-center gap-8">
          ...
          <a
            ...
            className="group relative rounded-full bg-[#4af0c4] px-10 py-5 text-base font-bold text-[#1f1f1f] transition-all hover:bg-[#6af5d4] hover:shadow-[0_0_60px_rgba(74,240,196,0.3)]"
          >
